...
public enum ErrorCode {
    ...
    MEMBER_NOT_ACTIVE(HttpStatus.FORBIDDEN, "이용이 제한된 계정입니다. 고객센터로 문의해주세요."),
    ...
    ORDER_FORBIDDEN(HttpStatus.FORBIDDEN, "해당 주문에 접근할 권한이 없습니다."),
    ...
    PAYMENT_NOT_PAYABLE(HttpStatus.BAD_REQUEST, "결제할 수 없는 주문 상태입니다."),
    PAYMENT_REFUND_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "환불 처리 중 오류가 발생했습니다."),
    PAYMENT_REFUND_UNAVAILABLE(HttpStatus.CONFLICT, "결제 정보를 찾을 수 없어 환불할 수 없습니다. 고객센터로 문의해주세요."),
