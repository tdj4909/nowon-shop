      ...
      <div className="flex items-center justify-between w-full px-4 py-3 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:border-gray-700 dark:hover:bg-gray-800"
          >
            로그아웃
          </button>
        </div>
